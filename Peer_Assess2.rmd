...
```{r Setup Processing, results="hide"}
...
```{r Process data to find most harmful types of events, results="hide"}
...
``` {r prepare population impact plotting}
...
``` {r explore the codes for damages (PROPDMGEXP and CROPDMGEXP)}
...
```{r explore the codes for damages - CROPDMGEXP}
...
```{r Process data to find highest economic impact per types of events, results="hide"}
...
``` {r prepare Economic impact plotting}
